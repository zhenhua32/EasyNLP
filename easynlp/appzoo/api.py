...
from easynlp.appzoo import (
    TextMatch,
    TextMatchTwoTower,
    DistillatoryTextMatch,
    FewshotSingleTowerTextMatch,
    CptFewshotSingleTowerTextMatch,
)
from easynlp.appzoo import (
    SequenceLabeling,
    LanguageModeling,
...
from easynlp.appzoo import (
    TextMatchPredictor,
    TextMatchTwoTowerPredictor,
    FewshotSingleTowerTextMatchPredictor,
    CptFewshotSingleTowerTextMatchPredictor,
)
...
from easynlp.appzoo import (
    SingleTowerDataset,
    TwoTowerDataset,
    DistillatorySingleTowerDataset,
    FewshotSingleTowerTextMatchDataset,
    SiameseDataset,
)
        ...
        if app_name.startswith(name):
            ...
            if len(union_name) == 0:
                return evaluator["others"](
                    valid_dataset=valid_dataset, user_defined_parameters=user_defined_parameters, **kwargs
                )
            elif union_name[0] == "enable_fewshot":
                fewshot_type = app_parameters.get("type")
                ...
                return evaluator[union_name[0]](
                    valid_dataset, user_defined_parameters=user_defined_parameters, **kwargs
                )
...
def default_main_fn():
    ...
    try:
        ...
        if (
            "mg" in model_info
            or args.mg_model
            or ("latest_checkpointed_iteration.txt" in checkpoint_files and "pytorch_model.bin" not in checkpoint_files)
        ):
