...
from easynlp.appzoo import (
    ...
    get_application_evaluator,
    get_application_model,
    get_application_model_for_evaluation,
    get_application_predictor,
)
from easynlp.core import PredictorManager, Trainer
from easynlp.utils import get_args, initialize_easynlp
...
if __name__ == "__main__":
    ...
    if args.mode == "predict":
        ...
        # tables 需要定义两个文件, 第一个是 train, 第二个是 valid
